...
namespace RoleUserAppPolicy.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public GroupsController(RoleUserAppContext context)
        {
            _context = context;
        }

        // GET: Groups
        [CustomAuthorize("Groups.Index")]
        ...
        [CustomAuthorize("Groups.Details")]
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RoleUserAppContext.Groups'  is null.");
            }
            var @group = await _context.Groups.FindAsync(id);
            if (@group != null)
            {
